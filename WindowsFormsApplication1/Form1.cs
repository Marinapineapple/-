...
namespace WindowsFormsApplication1
{
 ...
 //параметры открытия
            ...
            {
                return CloseHandle(handle); //закрыть дискриптор окна
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                string codpass = Encode(password_1);//кодирование пароля
                ...
                if (fr.OpenRead(drive)) //вызов для чтения
                {
                    ...
                    if (temp[0] == 0)//пароль еще не записан на флешке
                    {
                        fr.OpenWrite(drive);
                        {
                            ...
                            this.Hide();
                            Form2 f = new Form2(); //Вывод на экран окна успешного ввода
                            f.Show();
                        }
                        fr.Close();
                    }
